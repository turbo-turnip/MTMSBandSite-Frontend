...
export default function PracticePopup(props) {
    ...
    return (
        <div className="practice-time-popup" style={{ display: props.visible ? "flex" : "none" }}>
            ...
            <input type="number" placeholder="Practice time in minutes..." onChange={e => parseInt(e.target.value) > 29 && setMinutes(e.target.value)} required />
